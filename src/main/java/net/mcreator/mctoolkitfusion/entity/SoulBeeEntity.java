...
public class SoulBeeEntity extends MctoolkitFusionModElements.ModElement {

	public static EntityType entity = null;

	public SoulBeeEntity(MctoolkitFusionModElements instance) {
		super(instance, 209);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("soul_bee")
						.setRegistryName("soul_bee");

		elements.entities.add(() -> entity);

		elements.items.add(() -> new SpawnEggItem(entity, -16724788, -16711681, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("soul_bee_spawn_egg"));
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsoul_bee(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("mctoolkit_fusion:textures/soul_bee.png");
					}
				};
			});
