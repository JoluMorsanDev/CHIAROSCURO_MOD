...
public class MctoolkitFusionModVariables {
	public MctoolkitFusionModVariables(MctoolkitFusionModElements elements) {
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		if (event.getObject() instanceof PlayerEntity && !(event.getObject() instanceof FakePlayer))
			event.addCapability(new ResourceLocation("mctoolkit_fusion", "player_variables"), new PlayerVariablesProvider());
	}
