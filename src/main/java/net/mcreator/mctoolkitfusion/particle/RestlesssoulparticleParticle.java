...
package net.mcreator.mctoolkitfusion.particle;
...
public class RestlesssoulparticleParticle extends MctoolkitFusionModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public RestlesssoulparticleParticle(MctoolkitFusionModElements instance) {
		super(instance, 150);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("restlesssoulparticle"));
	}
