...
package net.mcreator.mctoolkitfusion.world.biome;
...
import net.mcreator.mctoolkitfusion.block.EndGrassBlock;
...
public class EndPlainsBiome extends MctoolkitFusionModElements.ModElement {
	public static Biome biome;
	public EndPlainsBiome(MctoolkitFusionModElements instance) {
		super(instance, 193);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-12768689).setWaterFogColor(-12768689)
						.withSkyColor(7972607).withFoliageColor(-10607209).withGrassColor(-10607209).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(EndGrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("mctoolkit_fusion:end_plains"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("end_plains_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("end_plains_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("end_plains_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
