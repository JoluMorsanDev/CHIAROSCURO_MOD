...
import net.mcreator.mctoolkitfusion.procedures.SoulSpawnerUpdateTickProcedure;
...
public class SoulSpawnerBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soul_spawner")
	public static final Block block = null;
	public SoulSpawnerBlock(MctoolkitFusionModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SoulSpawnerUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
