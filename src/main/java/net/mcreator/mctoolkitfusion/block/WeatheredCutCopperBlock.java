...
public class WeatheredCutCopperBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:weathered_cut_copper")
	public static final Block block = null;
	public WeatheredCutCopperBlock(MctoolkitFusionModElements instance) {
		super(instance, 23);
	}
