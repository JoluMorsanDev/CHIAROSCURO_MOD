...
public class LightlyWeatheredCooperStairsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:lightly_weathered_cooper_stairs")
	public static final Block block = null;
	public LightlyWeatheredCooperStairsBlock(MctoolkitFusionModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lightly_weathered_cooper_stairs");
		}
