...
public class SoulLogBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soul_log")
	public static final Block block = null;
	public SoulLogBlock(MctoolkitFusionModElements instance) {
		super(instance, 13);
	}
