...
public class SoulCrystalOreBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soul_crystal_ore")
	public static final Block block = null;
	public SoulCrystalOreBlock(MctoolkitFusionModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("soul_crystal_ore");
		}
