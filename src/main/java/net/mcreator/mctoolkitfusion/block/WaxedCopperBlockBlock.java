...
public class WaxedCopperBlockBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:waxed_copper_block")
	public static final Block block = null;
	public WaxedCopperBlockBlock(MctoolkitFusionModElements instance) {
		super(instance, 24);
	}
