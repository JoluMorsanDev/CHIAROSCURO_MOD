...
public class LightlyWeatheredCopperSlabsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:lightly_weathered_copper_slabs")
	public static final Block block = null;
	public LightlyWeatheredCopperSlabsBlock(MctoolkitFusionModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lightly_weathered_copper_slabs");
		}
