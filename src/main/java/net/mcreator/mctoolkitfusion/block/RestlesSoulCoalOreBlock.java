...
public class RestlesSoulCoalOreBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:restles_soul_coal_ore")
	public static final Block block = null;
	public RestlesSoulCoalOreBlock(MctoolkitFusionModElements instance) {
		super(instance, 145);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("restles_soul_coal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RestlessSoulCoalItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
