...
public class RestlessSoulLogBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:restless_soul_log")
	public static final Block block = null;
	public RestlessSoulLogBlock(MctoolkitFusionModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("restless_soul_log");
		}
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			if (SoulLogParticleSpawningConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
				for (int l = 0; l < 2; ++l) {
