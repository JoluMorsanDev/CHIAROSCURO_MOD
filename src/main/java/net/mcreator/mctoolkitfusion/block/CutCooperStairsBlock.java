...
public class CutCooperStairsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:cut_cooper_stairs")
	public static final Block block = null;
	public CutCooperStairsBlock(MctoolkitFusionModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_cooper_stairs");
		}
