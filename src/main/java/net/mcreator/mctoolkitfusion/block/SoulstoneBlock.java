...
public class SoulstoneBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soulstone")
	public static final Block block = null;
	public SoulstoneBlock(MctoolkitFusionModElements instance) {
		super(instance, 2);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 20)).range(256).square().func_242731_b(36));
	}
}
