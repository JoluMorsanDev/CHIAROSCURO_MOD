...
public class WaxedCutCooperStairsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:waxed_cut_cooper_stairs")
	public static final Block block = null;
	public WaxedCutCooperStairsBlock(MctoolkitFusionModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("waxed_cut_cooper_stairs");
		}
