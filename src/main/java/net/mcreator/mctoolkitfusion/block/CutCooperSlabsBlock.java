...
public class CutCooperSlabsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:cut_cooper_slabs")
	public static final Block block = null;
	public CutCooperSlabsBlock(MctoolkitFusionModElements instance) {
		super(instance, 37);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cut_cooper_slabs");
		}
