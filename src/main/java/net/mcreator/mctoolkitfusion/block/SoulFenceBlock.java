...
public class SoulFenceBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soul_fence")
	public static final Block block = null;
	public SoulFenceBlock(MctoolkitFusionModElements instance) {
		super(instance, 11);
	}
