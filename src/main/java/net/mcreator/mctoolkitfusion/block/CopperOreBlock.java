...
public class CopperOreBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(MctoolkitFusionModElements instance) {
		super(instance, 1);
	}
