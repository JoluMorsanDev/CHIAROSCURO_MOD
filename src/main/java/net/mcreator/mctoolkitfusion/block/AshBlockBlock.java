...
public class AshBlockBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:ash_block")
	public static final Block block = null;
	public AshBlockBlock(MctoolkitFusionModElements instance) {
		super(instance, 144);
	}
