...
public class WeatheredCooperStairsBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:weathered_cooper_stairs")
	public static final Block block = null;
	public WeatheredCooperStairsBlock(MctoolkitFusionModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("weathered_cooper_stairs");
		}
