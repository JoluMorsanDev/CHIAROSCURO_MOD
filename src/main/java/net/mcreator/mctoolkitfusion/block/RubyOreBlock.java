...
import net.mcreator.mctoolkitfusion.item.RubyItem;
...
public class RubyOreBlock extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(MctoolkitFusionModElements instance) {
		super(instance, 201);
