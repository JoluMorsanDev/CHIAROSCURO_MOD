...
public class SoulcrystalshardItem extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:soulcrystalshard")
	public static final Item block = null;
	public SoulcrystalshardItem(MctoolkitFusionModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("soulcrystalshard");
		}
