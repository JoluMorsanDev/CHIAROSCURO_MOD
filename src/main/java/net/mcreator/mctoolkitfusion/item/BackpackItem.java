...
import net.mcreator.mctoolkitfusion.gui.BackpackGUIGui;
...
public class BackpackItem extends MctoolkitFusionModElements.ModElement {
	@ObjectHolder("mctoolkit_fusion:backpack")
	public static final Item block = null;
	public BackpackItem(MctoolkitFusionModElements instance) {
		super(instance, 212);
